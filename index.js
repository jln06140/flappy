...
// if (pause) {
//   window.setInterval(animateScene, 0);
//   window.setInterval(score, 0);
// }
// else {
//   window.setInterval(animateScene, 80);
//   window.setInterval(score, 80);
// }
...
function touchPipe(pipe) {
  ...
  if (birdyUp < 0 || birdyDown > (window.innerHeight)) {
    perdu = true;
  }

  finPartie();
    // document.body.innerHTML = "<div id='perdu'>perdu</div>";
...
function finPartie(){
  if (perdu) {
    document.body.innerHTML = "<div id='perdu'><p>perdu</p><p>Votre score est : "+scoreJeu+"</div>";
    clearInterval(animateInterval );
    clearInterval(incrementeScore);
  }
}
...
function score() {
  ...
  document.getElementById("score").innerHTML = scoreJeu;
  scoreJeu++;
}
...
var animateInterval  = window.setInterval(animateScene, 80);

var incrementeScore = window.setInterval(score, 80);
